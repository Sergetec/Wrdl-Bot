...
const WHITE = '#ffffff'
GlobalFonts.registerFromPath('/Wrdl-Bot/Fonts/ARLRDBD.ttf', { family: "Arial Rounded MT Bold"})
GlobalFonts.registerFromPath('/Wrdl-Bot/Fonts/micross.ttf', 'Microsoft Sans Serif')
